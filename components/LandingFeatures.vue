<template>
  <div class="relative bg-white py-2 sm:py-24 lg:py-10">
    <div
      class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl"
    >
      <h2
        class="text-base font-semibold tracking-wider text-primary-light uppercase"
      >
        Everything you need to run your app freely!
      </h2>
      <p
          ...
          <div v-for="feature in features" :key="feature.name" class="pt-6">
            <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
              <div class="-mt-6">
                <div>
                  <span
                    class="inline-flex items-center justify-center p-3 bg-ghost rounded-md shadow-lg border-2"
                  >
                    <component
                      :is="feature.icon"
