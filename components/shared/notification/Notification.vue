<template>
  ...
  <div aria-live="assertive" class="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
    <div class="w-full flex flex-col mt-auto items-center space-y-4 sm:items-end">
          ...
          <div class="p-4">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <WarningIcon v-show="params.type == notifications.WARNING" class="h-10 w-10" />
                <SuccessIcon v-show="params.type == notifications.SUCCESS" class="h-10 w-10" />
                <FailureIcon v-show="params.type == notifications.ERROR" class="h-10 w-10" />
                <InfoIcon v-show="params.type == notifications.INFO" class="h-10 w-10" />
              </div>
              ...
              <div class="h-3 relative max-w-xl rounded-full overflow-hidden">
                  ...
                  <div class="h-full relative w-0" :style="{'width' : percentage + '%'}" :class="classObject"></div>
              </div>
        </div>
