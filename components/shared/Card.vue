  ...
  created () {
    ...
    this.connection.onmessage = (message) => {
      ...
      for (const n of this.stats) {
        if (n.status === 'success') { this.successData.store(n.count) } else if (n.status === 'failure') { this.failureData.store(n.count) } else if (n.status === 'pending') { this.pendingData.store(n.count) } else if (n.status === 'started') { this.startedData.store(n.count) } else if (n.status === 'ignored') { this.ignoredData.store(n.count) } else if (n.status === 'rejected') { this.rejectedData.store(n.count) }
      }
    }
  },
  mounted () {
