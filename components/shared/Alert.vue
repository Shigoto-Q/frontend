          ...
          <div class="p-4">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <CheckMarkIcon  class="h-6 w-6 text-green-400" aria-hidden="true" />
              </div>
              ...
              <div class="ml-4 flex-shrink-0 flex">
                <button @click="closeAlert" class="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
