            ...
            <thead class="bg-gray-50">
              <tr>
                <th
                  ...
                  scope="col"
                  class="w-fit px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                >
                  {{ col.title }}
                </th>
                <th
                  scope="col"
                  class="w-fit px-6 py-3 text-mana text-center font-semibold uppercase tracking-wider"
                >
                  Run
                </th>
                <th
