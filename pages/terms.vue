      ...
      <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto">
          ...
          <p class="mt-8 text-xl text-gray-500 leading-8">
            ...
            use of Shigoto's Website, located at https://shigo.to.
          </p>
        </div>
        <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use shigoto if you do not agree to
            take all of the terms and conditions stated on this page. Cookies:
          </p>
          <p>
            The website uses cookies to help personalize your online experience.
            By accessing shigoto, you agreed to use the required cookies.
          </p>
          <p>
          ...
          <p>
            ...
            intellectual property rights for all material on shigoto. All
            intellectual property rights are reserved. You may access this from
            shigoto for your own personal use subjected to restrictions set in
          ...
          <ul>
            ...
            <li>Sell, rent, or sub-license material from shigoto</li>
            <li>Reproduce, duplicate or copy material from shigoto</li>
            <li>Redistribute content from shigoto</li>
          </ul>
          <p>This Agreement shall begin on the date hereof.</p>
          <p>
            Parts of this website offer users an opportunity to post and
            exchange opinions and information in certain areas of the website.
            Shigoto does not filter, edit, publish or review Comments before
            their presence on the website. Comments do not reflect the views and
            opinions of Shigoto, its agents, and/or affiliates. Comments reflect
            the views and opinions of the person who posts their views and
            opinions. To the extent permitted by applicable laws, Shigoto shall
            not be liable for the Comments or any liability, damages, or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            Shigoto reserves the right to monitor all Comments and remove any
          ...
          <p>
            You hereby grant Shigoto a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Shigoto; and
          ...
          <p>
            ...
            sending an e-mail to Shigoto. Please include your name, your
          ...
          <p>
            No use of Shigoto's logo or other artwork will be allowed for
