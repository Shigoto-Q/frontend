          ...
          <div>
            ...
            <div class="mt-2">
              <div class="mt-6 sm:max-w-xl">
                <h1 class="text-3xl font-extrabold text-comet tracking-tight sm:text-4xl">The simplest way to run your code on Kubernetes.</h1>
              </div>
        ...
        <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
          <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            ...
            <div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
              <img class="w-fit rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="../assets/images/dashboardSafari.png" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
          <div class="relative sm:py-16 lg:py-0">
            ...
            <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
              <div class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-contain" src="../assets/images/dashboardFeature1.png" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div class="pt-12 sm:pt-16 lg:pt-20">
              <h2 class="text-3xl text-gray-900 font-extrabold tracking-tight sm:text-4xl">Make your DevOps life easier.</h2>
              <div class="mt-6 text-gray-500 space-y-6">
              <p class="text-lg">Shigoto is a managed Kubernetes service that lets you deploy, monitor and manage your containers via an intuitive web interface. </p>
              <p class="text-base leading-7">With Shigoto, you don’t need to worry about operating servers or clusters. Deploying and managing your cluster is as easy as clicking a button.</p>
              <p class="text-base leading-7">Create powerful workflows. Scale up and down automatically, paying only when you need it. </p>
              </div>
              </div>
          </div>
        </div>
