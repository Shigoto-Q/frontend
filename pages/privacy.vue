    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          ...
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        <p class="mt-8 text-xl text-gray-500 leading-8">Your privacy is important to us. It is Shigoto&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://shigo.to">https://shigo.to</a>, and other sites we own and operate. </p>
        <p class="mt-8 text-xl text-gray-500 leading-8">This policy is effective as of 9 April 2022 and was last updated on 9 April 2022. </p>
      </div>
      <h1>
        <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Information we collect</span>
        <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
      </h1>
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Log Data</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Personal Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Collection and Use of Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Security of Your Personal Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">How long we keep your personal Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Children's Privacy</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Disclosure of Personal Information to Third Parties</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">International Transfers of Personal Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Your Rights and Controlling Your Personal Information</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Use of Cookies</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Limits of Our Policy</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices. </p>
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Changes to This policy</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        ...
        <h1>
          <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Contact us</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"></span>
        </h1>
        <p>For any questions or concerns regarding your privacy, you may contact us using the following details: </p>
        <p>simeon.aleksov@shigo.to<br />
          info@shigo.to </p>
      </div>
    </div>
  </div>
