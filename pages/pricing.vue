    ...
    <div class="relative max-w-2xl mx-auto pt-16 px-4 text-center sm:pt-32 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="max-w-6xl space-y-8 lg:text-center">
        ...
        >
          ...
          <p class="text-xl text-comet">Everything you need, nothing you don't. Pick a plan that best suits your business.</p>
      </div>
    </div>
      ...
      <div class="hidden lg:block">
            ...
            <tr v-for="feature in section.features" :key="feature.name">
              ...
              <td v-for="tier in tiers" :key="tier.name" class="py-5 px-6">
                ...
                <template v-else>
                  ...
                  <XIcon v-else class="h-5 w-5 text-gray-400" aria-hidden="true" />
        ...
        <div class="flex justify-center mt-4">
          <p class="text-sm text-comet self-center">
            Shigoto will contribute 0.5% of your purchase to remove CO₂ from the atmosphere.
            Read more <a class="text-link" href="https://climate.stripe.com/GcbOW2">here.</a></p>
        </div>
      </div>
    </div>
  </div>
...
export default {
      ...
      sections:  [
        {
          name: 'Kubernetes',
          features: [
            { name: 'Deployments', tiers: { Personal: ' 1 deployments', Professional: 'Up to 5 deployments', Business: 'Up to 100 deployments' } },
            { name: 'Services', tiers: { Personal: '1 service', Professional: 'Up to 5 services', Business: 'Up to 100 services' } },
            { name: 'Ingress', tiers: { Professional: true, Business: true } },
            { name: 'Ingress SSL/TLS', tiers: { Personal: true, Professional: true, Business: true } },
            { name: 'Namespace', tiers: { Personal: '1 namespace', Professional: '1 namespace', Business: 'Up to 5 namespaces' } },
        ...
        },
        {
          name: 'Docker',
          features: [
            { name: 'Image build', tiers: { Personal: true, Professional: true, Business: true } },
            { name: 'Image push', tiers: { Personal: true, Professional: true, Business: true } },
        ...
        },
        {
          name: 'Cron jobs',
          features: [
            { name: 'Simple HTTP Operator', tiers: { Personal: true, Professional: true, Business: true } },
            { name: 'Kubernetes job', tiers: { Professional: true, Business: true } },
            { name: 'Docker job', tiers: { Personal: true, Professional: true, Business: true } },
          ],
        },
        {
          name: 'Monitoring & Alerts',
          features: [
            { name: 'Discord integration', tiers: { Personal: true, Professional: true, Business: true } },
            { name: 'Slack integration', tiers: { Personal: true, Professional: true, Business: true } },
            { name: 'E-mail notifications', tiers: { Personal: true, Professional: true, Business: true } },
  ...
  methods: {
    ...
    handleCheckout() {
      ...
      this.$axios.post("/api/v1/customer/subscription/session/create/", body, config)
        .then((res) => {
          console.log(res)
