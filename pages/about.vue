    ...
    <div class="relative py-16 bg-white overflow-hidden">
      ...
      <div class="relative px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
          <p>
            Shigoto will let you <strong>build and push</strong> docker images,
            <strong>deploy on kubernetes</strong>, create scheduled tasks and
            more. We here at Shigoto have decided to provide a SaaS solution for
            our community, so that you can focus on building your apps without
            having to worry about the nitty gritty details of deployments,
            keeping track of what's deployed etc.,
          </p>
          <p>
            Or dealing with custom tools built by individual developers that may
            get abandoned after usage of them dilutes across the community.
          </p>
          <p>
            Founded in 2022 by Simeon and Bogdan,
            <span class="text-primary">Shigoto</span> has come a long way from
            its beginnings. We hope you enjoy our products as much as we enjoy
